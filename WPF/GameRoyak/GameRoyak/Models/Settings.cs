...
namespace GameRoyak.Models
{
    public static class Settings
    {
        ...
        public static readonly string DirectoryJsons = Directory.GetParent(Directory.GetParent(Environment.CurrentDirectory).FullName).Parent.FullName+"/GameRoyak/Jsons/";
        public static readonly string MainDirectory = Directory.GetParent(Directory.GetParent(Environment.CurrentDirectory).FullName).Parent.FullName+ "/GameRoyak/";
        public static void InitializeSettings()
        {

            var settings = JObject.Parse(File.ReadAllText(FilePath.Combine(DirectoryJsons, "Settings.json")));
