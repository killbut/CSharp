...
namespace GameRoyak.Pages
{
    public partial class Shop : Page
    {
        ...
        public Shop(Player player)
        {
            ...
            var allJson = JObject.Parse(File.ReadAllText(FilePath.Combine(Settings.DirectoryJsons, "Items.json")));
        ...
        private void SetCardItem(Item item, int numCard)
        {
            ...
            var icon = new Image
            { Source = new BitmapImage(new Uri(FilePath.Combine(Settings.MainDirectory, item.Icon))) };
